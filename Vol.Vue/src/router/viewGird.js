let viewgird = [
   {
    ...
    ,{
      ...
      component: () => import('@/views/order/vSellOrderImg.vue')
        ...
        path: '/App_Customer',
        name: 'App_Customer',
        component: () => import('@/views/appmanager/customer/App_Customer.vue')
    }   ,{
        path: '/App_PublicResources',
        name: 'App_PublicResources',
        component: () => import('@/views/appmanager/publicresources/App_PublicResources.vue')
    } ,{
        path: '/App_EmployeeCustomer',
        name: 'App_EmployeeCustomer',
        component: () => import('@/views/appmanager/customer/App_EmployeeCustomer.vue')
    }    ,{
        path: '/Sys_Store',
        name: 'Sys_Store',
        component: () => import('@/views/system/system/Sys_Store.vue')
    }    ,{
        path: '/App_AddCustomer',
        name: 'App_AddCustomer',
        component: () => import('@/views/appmanager/customer/App_AddCustomer.vue')
    }]
